...
async def health_check():
    ...
    # Temporarily disable taco search health check due to hanging issues
    # TODO: Fix MCP communication hanging and re-enable this check
    taco_search_mcp_status = True  # await taco_search_client.health_check()
